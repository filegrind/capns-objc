...
- (void)testRegisterAndFindCapSet {
    ...
    NSError *error = nil;
    CSCapUrn *capUrn = [CSCapUrn fromString:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\";type=basic" error:&error];
    ...
    NSArray<id<CSCapSet>> *sets = [self.registry findCapSets:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\";type=basic" error:&findError];
    ...
    sets = [self.registry findCapSets:@"cap:in=\"media:type=void;v=1\";model=gpt-4;op=test;out=\"media:type=object;v=1\";type=basic" error:&findError];
    ...
    // Test no match
    sets = [self.registry findCapSets:@"cap:in=\"media:type=void;v=1\";op=different;out=\"media:type=object;v=1\"" error:&findError];
...
- (void)testBestCapSetSelection {
    ...
    CSCapUrn *generalCapUrn = [CSCapUrn fromString:@"cap:in=\"media:type=void;v=1\";op=generate;out=\"media:type=object;v=1\"" error:nil];
    ...
    CSCapUrn *specificCapUrn = [CSCapUrn fromString:@"cap:in=\"media:type=void;v=1\";model=gpt-4;op=generate;out=\"media:type=object;v=1\";type=text" error:nil];
    ...
    id<CSCapSet> bestHost = [self.registry findBestCapSet:@"cap:in=\"media:type=void;v=1\";model=gpt-4;op=generate;out=\"media:type=object;v=1\";temperature=low;type=text" error:&error capDefinition:&capDefinition];
    ...
    NSArray<id<CSCapSet>> *allHosts = [self.registry findCapSets:@"cap:in=\"media:type=void;v=1\";model=gpt-4;op=generate;out=\"media:type=object;v=1\";temperature=low;type=text" error:&error];
...
- (void)testCanHandle {
    // Empty registry
    BOOL canHandle = [self.registry canHandle:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\""];
    ...
    CSCapUrn *capUrn = [CSCapUrn fromString:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\"" error:nil];
    CSCap *cap = [CSCap capWithUrn:capUrn
                             title:@"Test"
                           command:@"test"
                       description:@"Test"
    ...
    canHandle = [self.registry canHandle:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\""];
    XCTAssertTrue(canHandle, @"Registry should handle registered capability");

    canHandle = [self.registry canHandle:@"cap:extra=param;in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\""];
    XCTAssertTrue(canHandle, @"Registry should handle capability with extra parameters");

    canHandle = [self.registry canHandle:@"cap:in=\"media:type=void;v=1\";op=different;out=\"media:type=object;v=1\""];
...
- (void)testUnregisterCapSet {
    ...
    XCTAssertTrue([self.registry canHandle:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\""], @"Should handle capability before unregistering");
    ...
    // Verify it's gone
    XCTAssertFalse([self.registry canHandle:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\""], @"Should not handle capability after unregistering");
...
- (void)testClear {
    ...
    // Verify it's registered
    XCTAssertTrue([self.registry canHandle:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\""], @"Should handle capability before clearing");
    ...
    XCTAssertFalse([self.registry canHandle:@"cap:in=\"media:type=void;v=1\";op=test;out=\"media:type=object;v=1\""], @"Should not handle any capabilities after clearing");
